...
(async () => {
  const userDataDir = process.env.EDGE_USER_DATA || "C:\\Users\\lucid\\AppData\\Local\\Temp\\edge-profile-notebooklm";
  const profileDir = process.env.EDGE_PROFILE_DIR || "Default";
