...
- Regulatory-compliant disclaimers (FCA/FTC/EU AI Act)
"""
...
# =============================================================================
# COMPLIANCE: Financial Disclaimers (FCA/FTC/EU AI Act)
# =============================================================================

FINANCIAL_DISCLAIMER_SHORT = (
    "_Not financial advice. Crypto is highly volatile. DYOR._"
)

FINANCIAL_DISCLAIMER_FULL = """
*IMPORTANT DISCLAIMER*

This information is provided by JARVIS, an AI-powered market analysis tool.
...
_JARVIS uses AI models including xAI Grok and Claude. Information may contain errors._
"""

AI_DISCLOSURE = "_Generated by JARVIS AI using Grok, Claude, and on-chain data._"
...
def format_hourly_digest(
    ...
    lines.append(FINANCIAL_DISCLAIMER_SHORT)
...
def format_disclaimer() -> str:
    """Return the full financial disclaimer for /disclaimer command."""
    return FINANCIAL_DISCLAIMER_FULL
