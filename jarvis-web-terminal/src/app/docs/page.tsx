...
export default function DocsPage() {
    return (
        <div className="min-h-screen bg-theme-white text-theme-ink p-8 pt-32 font-sans relative overflow-hidden">
            {/* Header */}
            <header className="fixed top-0 left-0 right-0 z-50 p-6 flex justify-between items-center backdrop-blur-sm bg-theme-white/30 border-b border-border-primary/50">
