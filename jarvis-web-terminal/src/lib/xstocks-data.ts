...
export type EquityCategory = 'XSTOCK' | 'PRESTOCK' | 'INDEX' | 'COMMODITY';
...
export const PRESTOCKS: TokenizedEquity[] = [
...
export const INDEXES: TokenizedEquity[] = [
...
export const COMMODITIES_TOKENS: TokenizedEquity[] = [
...
export const ALL_TOKENIZED_EQUITIES: TokenizedEquity[] = [
  ...XSTOCKS,
  ...PRESTOCKS,
  ...INDEXES,
  ...COMMODITIES_TOKENS,
...
export const EQUITY_BY_MINT = new Map(
  ALL_TOKENIZED_EQUITIES.map(eq => [eq.mintAddress, eq])
);

// Quick lookup by ticker
export const EQUITY_BY_TICKER = new Map(
  ALL_TOKENIZED_EQUITIES.map(eq => [eq.ticker, eq])
);
