...
export const STRATEGY_INFO: Record<string, {
  ...
  momentum: {
    summary: 'Research-only mean-reversion dip-buy with wider TP.',
    optimal: 'Only worth testing when conditions are choppy and you expect sharp bounces.',
    risk: 'Quarantined from live routing while the event model and cost assumptions are being rebuilt.',
  ...
  hybrid_b: {
    summary: 'Research-only hybrid dip entry.',
    optimal: 'Best tested during mean-reverting conditions (not straight-line pumps).',
    risk: 'Quarantined from live routing while the event model is being retuned.',
    params: 'SL 10% | TP 25% | Trail OFF (99) | Liq $5K+ | Score 30+ | Age <200h',
  ...
  let_it_ride: {
    summary: 'Research-only wider hold window.',
  ...
  volume_spike: {
    summary: 'Research-only established volume surge entry.',
    optimal: 'Only worth testing when you trust the surge source (listing/news/rotation).',
    risk: 'Volume spikes can be exit liquidity. This preset stays quarantined until confirmation logic is rebuilt.',
  ...
  established_breakout: {
    summary: 'Research-only established breakout signals.',
    optimal: 'Best tested when the market is trending and breakouts actually follow through.',
    risk: 'Breakouts often fake out. This preset stays quarantined until confirmation logic is rebuilt.',
  ...
  xstock_intraday: {
    summary: 'Disabled from the production surface until xStocks data is production-valid.',
    ...
    bestFor: 'Revisit only after TradFi backtesting is rebuilt',
    riskLevel: 'EXTREME',
  ...
  xstock_swing: {
    ...
    risk: 'TradFi presets stay disabled until the data and execution model are rebuilt.',
    params: 'SL 4% | TP 10% | Trail OFF (99) | (TradFi dataset pending)',
    bestFor: 'Revisit only after TradFi backtesting is rebuilt',
    riskLevel: 'EXTREME',
    holdTime: 'Usually exits within: TBD',
  ...
  prestock_speculative: {
    summary: 'Disabled from the production surface until prestock data is production-valid.',
    optimal: 'Pending real prestock candle ingestion and parameter retuning.',
    risk: 'This stays disabled until data and scoring are verified end-to-end.',
    params: 'SL 4% | TP 10% | Trail OFF (99) | (TradFi dataset pending)',
    bestFor: 'Revisit only after TradFi backtesting is rebuilt',
    riskLevel: 'EXTREME',
    holdTime: 'Usually exits within: TBD',
  ...
  index_intraday: {
    summary: 'Disabled from the production surface until index-token data is production-valid.',
    optimal: 'Pending real index-token candle ingestion and parameter retuning.',
    risk: 'This stays disabled until the dataset is real and the edge is validated.',
    params: 'SL 4% | TP 10% | Trail OFF (99) | (TradFi dataset pending)',
    bestFor: 'Revisit only after TradFi backtesting is rebuilt',
    riskLevel: 'EXTREME',
    holdTime: 'Usually exits within: TBD',
  ...
  index_leveraged: {
    summary: 'Disabled from the production surface until leveraged-index data is production-valid.',
    optimal: 'Pending real leveraged-index candle ingestion and parameter retuning.',
    risk: 'This stays disabled until the data is correct and the edge is proven.',
    params: 'SL 4% | TP 10% | Trail OFF (99) | (TradFi dataset pending)',
    bestFor: 'Revisit only after TradFi backtesting is rebuilt',
    riskLevel: 'EXTREME',
    holdTime: 'Usually exits within: TBD',
  ...
  bags_momentum: {
    summary: 'Research-only post-launch momentum on Bags.',
    optimal: 'Only worth testing when you see persistent bids and momentum is sustained.',
    risk: 'Quarantined from live routing until Bags momentum logic is retuned.',
...
const STRATEGY_SEED_STATUS = 'Status: Seeded paper baseline (R4 params, trailing disabled).';
