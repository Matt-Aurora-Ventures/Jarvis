...
class ConnectionWrapper:
    """Wrapper around database connection with metrics."""
...
class ConnectionPool:
    ...
    def get_connection(self) -> ConnectionWrapper:
        ...
        a new one (up to max_overflow limit).
        """
        if self._closed:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            **self._stats,
            ...
            "current_pool_count": self._pool.qsize(),
            "overflow_in_use": self._overflow_count,
            "total_active": self._total_connections,
        }
