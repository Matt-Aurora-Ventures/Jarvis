"""
KR8TIV Conversation Export - Export memory and context as shareable formats
...
class ConversationExporter:
    ...
    def __init__(
        ...
        self.instance_id = instance_id or "kr8tiv-memory"
    ...
    def _export_markdown(self, data: dict, options: ExportOptions) -> str:
        ...
        # Header
        lines.append("# KR8TIV Memory Export")
        lines.append("")
        ...
        lines.append("---")
        lines.append("")
        lines.append("*Exported with KR8TIV Memory Stack*")
    ...
    def _export_html(self, data: dict, options: ExportOptions) -> str:
        ...
        html_parts = [
            ...
            "  <title>KR8TIV Memory Export</title>",
            "  <style>",
        ...
        html_parts.extend([
            "    <footer>",
            "      <p>Exported with <strong>KR8TIV Memory Stack</strong></p>",
            "      <p><a href='https://github.com/Matt-Aurora-Ventures/Jarvis'>GitHub</a></p>",
            "    </footer>",
            "  </div>",
            "</body>",
            "</html>",
