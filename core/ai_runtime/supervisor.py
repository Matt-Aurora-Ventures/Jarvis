"""AI Supervisor for optional component intelligence."""
...
from core.ai_runtime.agents import build_default_agents, AgentReport
    ...
    async def run_once(self) -> List[AgentReport]:
        ...
        for agent in self.agents:
            try:
                ...
                logger.debug(f"Agent {agent.name} failed: {exc}")
        return reports
    ...
    async def start(self) -> None:
        ...
        while self._running:
            try:
                ...
                logger.debug(f"AI supervisor loop error: {exc}")
