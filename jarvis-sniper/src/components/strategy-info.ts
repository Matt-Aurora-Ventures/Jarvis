...
export const STRATEGY_INFO: Record<string, {
  ...
  xstock_intraday: {
    summary: 'Experimental TradFi preset. Latest run is profitable with robust sample, but win rate is intentionally low.',
    optimal: 'Best for high-R setups where you can tolerate many small losses before large winners.',
    risk: 'Low WR/high variance profile. Keep size small and expect long dry spells.',
    params: 'SL 8% | TP 100% | Trail OFF (99) | Max age 336h | TradFi experimental',
    bestFor: 'Advanced users comfortable with low WR / high-R systems',
    riskLevel: 'EXTREME',
    holdTime: 'Usually exits within: 2-72 hours',
  },
  xstock_swing: {
    summary: 'Experimental TradFi swing preset. Latest run is profitable and passed consistency checks.',
    optimal: 'Best as a high-R swing setup with strict risk sizing and patient exits.',
    risk: 'Win rate remains low, so emotional and variance risk is high despite positive expectancy.',
    params: 'SL 10% | TP 100% | Trail OFF (99) | Max age 48h | TradFi experimental',
    bestFor: 'Advanced users who can run low WR / high-R swing logic',
    riskLevel: 'EXTREME',
    holdTime: 'Usually exits within: 2-48 hours',
  },
  prestock_speculative: {
    summary: 'Experimental TradFi preset. Latest run remains losing.',
    optimal: 'Manual validation only while discovery/data quality improves for prestock listings.',
    risk: 'Negative expectancy in current backtest. Keep excluded from auto-selection.',
    params: 'SL 4% | TP 10% | Trail OFF (99) | TradFi experimental',
    bestFor: 'Research/testing only',
    riskLevel: 'EXTREME',
    holdTime: 'Usually exits within: TBD',
  },
  index_intraday: {
    summary: 'Experimental index preset. Latest run remains losing.',
    optimal: 'Manual testing only while index universe/history are expanded.',
    risk: 'Negative expectancy in current run; keep excluded from auto-selection.',
    params: 'SL 4% | TP 10% | Trail OFF (99) | TradFi experimental',
    bestFor: 'Research/testing only',
    riskLevel: 'EXTREME',
    holdTime: 'Usually exits within: TBD',
  ...
  index_leveraged: {
    summary: 'Experimental leveraged index preset. Latest run remains losing.',
    optimal: 'Manual testing only while dataset quality and index mapping improve.',
    risk: 'Negative expectancy in current run; keep excluded from auto-selection.',
    params: 'SL 4% | TP 10% | Trail OFF (99) | TradFi experimental',
    bestFor: 'Research/testing only',
    riskLevel: 'EXTREME',
